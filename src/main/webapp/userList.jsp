...
<body>
	<div id="optStyle">
		<a href="userAction!addUser.do">新增用户</a> <a href="userAction.do">返回首页</a>
	</div>
		...
		<s:iterator value="userList" id="item">
			<tr>
				...
				<td><a href="javascript:none;"
					onclick="editUser(<s:property value="#item.id"/>);">编辑</a> <a
					href="javascript:none;"
					onclick="delUser(<s:property value="#item.id"/>);">删除</a></td>
			</tr>
		</s:iterator>
	...
	<div id="pageStyle">
		<a href="javascript:none;"
			onclick="goFirstPage(<s:property value="user.page"/>);">首页</a> <a
			href="javascript:none;"
			onclick="goUpPage(<s:property value="user.page"/>);">上一页</a> <a
			href="javascript:none;"
			onclick="goDownPage(<s:property value="user.page"/>);">下一页</a> <a
			href="javascript:none;" onclick="goLastPage('最后一页');">最后一页</a>
	</div>

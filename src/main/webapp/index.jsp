		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll"><a href="#portfolio">新闻</a></li>
					<li class="page-scroll"><a href="#about">关于我们</a></li>
				...
				<div class="col-lg-8 col-lg-offset-2">
					...
					<form name="sentMessage" id="contactForm" novalidate>
						...
						<div class="row control-group">
							<div
								...
								<label>邮箱</label> <input type="email" class="form-control"
									placeholder="邮箱" id="email" required
						...
						<div class="row control-group">
							<div
								class="form-group col-xs-12 floating-label-form-group controls">
								<label>联系方式</label> <input type="tel" class="form-control"
									placeholder="联系方式" id="phone" required
						...
						<div class="row control-group">
							<div
								class="form-group col-xs-12 floating-label-form-group controls">
								<label>消息</label>
								<textarea rows="5" class="form-control" placeholder="消息"
									id="message" required
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<img src="img/portfolio/cake.png"
								class="img-responsive img-centered" alt="">
							<p>红网长沙12月27日讯（时刻新闻记者 刘容 摄影
								李长宏）长沙磁浮快线12月26日正式开始试运行，敢为人先的长沙又一次走在全国众多城市前列，率先进入“磁浮时代”。湖南磁浮交通发展股份有限公司透露，接下来3个月里，将重点对磁浮各设备系统和整体系统进行可用性、安全性和可靠性考核，确保各项指标达到试运营的标准。</p>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<img src="img/portfolio/circus.png"
								class="img-responsive img-centered" alt="">
							<p>今年61岁的王兰群生活在河南省内黄县马上乡七里井村。2014年底，喜欢钻研机械的他开始购买金属材料自己设计制造“大型客机”。经过一年的努力，王兰群的“大型客机”已初步成型，外形酷似波音737。这架“飞机”通体银白色，长约35米，加上机翼宽约38米，机舱内高约2米。据了解，该“飞机”经过后期的完善和装修，将用于开设餐厅。
								文图据新华社</p>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<img src="img/portfolio/game.png"
								class="img-responsive img-centered" alt="">
							<p>12月26日凌晨，湖南韶山毛泽东广场上红旗飘飘，来自全国各地的数万民众来此进行祭拜活动，以纪念毛泽东诞辰122周年。杨华峰
								摄</p>
					...
					<div class="col-lg-8 col-lg-offset-2">
						<div class="modal-body">
							...
							<img src="img/portfolio/submarine.png"
								class="img-responsive img-centered" alt="">
							<p>日报记者 唐婷 贺佳 陈昂 长沙晚报记者
								舒薇）山水洲城，流光溢彩。12月26日晚，省会长沙迎来了一次特殊的检验。省委书记、省人大常委会主任徐守盛，省委副书记、省长杜家毫率领正在参加省委
								经济工作会议的全省市州、县（市区）党政一把手，参观了长沙城市建设，感受长沙新貌。</p>

...
<body class="light-gray-bg">
		...
		<form action="LoginAction!login.do" method="post">
			<div class="form-group">
				<div class="input-group">
					...
					<input name="loginName" type="text" class="form-control"
						onblur="validatorLoginName" placeholder="root@admin.com">
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
			...
			<div class="form-group">
				<div class="checkbox squaredTwo">
					<input type="checkbox" id="c1" name="cc" /> <label for="c1"><span></span>记住密码</label><strong><p>
							<a href="resetpwd.html" class="blue-text">忘记密码？</a></strong>
					</p>
				</div>
			</div>
			<div class="form-group">
	...
	<div
		...
		<p>
			还未进行注册？ <strong><a href="signup.html" class="blue-text">现在注册！</a></strong>
		</p>
	</div>
</body>
</html>